...
<div itemscope itemtype="http://schema.org/Organization">
	...
	<?php
		...
		$source = 'content';
		// Get the schema html
		echo katb_company_aggregate_display( $use_formatted_display , $group_name , 'Side Meta' );
	
		if( $display_reviews != 0 ) { 
	?>
		
		<div class="katb_test_wrap<?php echo $format; ?>_side_meta">
			...
			<?php
				...
				for ( $i = 0 ; $i < $katb_tnumber; $i++ ) {
					...
					<div class="katb_test_box<?php echo $format; ?>_side_meta" itemscope itemtype="http://schema.org/Review">
