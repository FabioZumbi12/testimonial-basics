...
<div itemscope itemtype="http://schema.org/Organization">
	...
	<?php
		...
		$source = 'content';
		// Get the schema html
		echo katb_company_aggregate_display( $use_formatted_display , $group_name , 'Top Meta' );
		...
		<div class="katb_test_wrap<?php echo $format; ?>">
			...
			<?php
				...
				for ( $i = 0 ; $i < $katb_tnumber; $i++ ) {
					...
					?>
					<div class="katb_test_box<?php echo $format; ?>" itemscope itemtype="http://schema.org/Review">
