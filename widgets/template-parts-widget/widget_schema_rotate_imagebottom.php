...
<div itemscope itemtype="http://schema.org/Organization">
	...
	<div class="katb_widget_rotate katb_widget_rotator_wrap<?php echo $format; ?> image_meta_bot" <?php echo $katb_widget_height_option_outside; ?> 
		...
		for ( $i = 0 ; $i < $katb_widget_tnumber; $i++ ) {
			...
			// rotator div
			if( $i == 0 ) { ?>
				<div class="katb_widget_rotator_box<?php echo $format; ?> katb_widget_rotate_show" itemscope itemtype="http://schema.org/Review" <?php echo $katb_widget_height_option; ?>>
			<?php } else { ?>
				<div class="katb_widget_rotator_box<?php echo $format; ?> katb_widget_rotate_noshow" itemscope itemtype="http://schema.org/Review" <?php echo $katb_widget_height_option; ?>>
			<?php } ?>
				...
				<?php } ?>
					...
					<div class="katb_image_meta_bottom">
						...
						<?php }else{ ?>
							...
							<div class="katb_meta_bottom_wrap widget_meta" style="width:calc(100% - <?php echo $width_adj; ?>px);">
								<?php }
